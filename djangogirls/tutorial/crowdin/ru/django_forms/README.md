...
Еще раз о том, что мы сейчас будем создавать: ссылку на страницу, URL-адрес, представление и шаблон.
...
Сохрани файл и перезагрузи страницу по адресу http://127.0.0.1:8000, ты должна увидеть знакомую ошибку `NoReverseMatch`, так?
...
Давай откроем `blog/views.py` и добавим в конец файла:
