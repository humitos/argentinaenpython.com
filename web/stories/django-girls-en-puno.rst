.. title: Taller Django Girls en Puno
.. slug: django-girls-puno
.. date: 2015-09-23 13:28:23 UTC-03:00
.. tags: eventos, django girls, django, taller, python, puno, perú
.. category: 
.. link: 
...
a `Python Puno <https://groups.io/org/groupsio/python-puno/>`_ estamos
...
que un programador profesional utiliza diariamente. ¡Y de una manera
muy sencilla!
...
.. sidebar:: Contacto
   ...
   `nuestro email <mailto:argentinaenpython@openmailbox.org>`_ para
...
* ... debes **revisar el email** durante los 7 días previos al evento para
  saber si recibiste la confirmación.

* ... no debes registrarte más de una vez. Sólo hazlo como Asistente o
  como Guía -no ambos.
...
.. raw:: html
   ...
   <div style="text-align: center; margin-top: 25px; margin-bottom: 25px;">
     <a class="btn btn-lg btn-primary" target="_blank" href="http://goo.gl/forms/TEjcCWFFdb">
       ¡Quiero inscribirme!
     </a>
   </div>
...
.. raw:: html
   ...
   <div style="text-align: center; margin-top: 25px; margin-bottom: 25px;">
     <a class="btn btn-lg btn-primary" target="_blank" href="http://goo.gl/forms/QaPbgtzgjt">
...
.. collapse:: ¿Habrá comida?
   ...
   habrá frutas y algo más como "snack".
...
.. admonition:: Nota
   ...
   marca: `Django Girls Puno
   <https://djangogirls.org/puno>`__
