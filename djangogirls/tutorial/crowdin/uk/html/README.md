...
*   Відкрийте [сторінку з терміналами на PythonAnywhere][5] і переключіться на вже запущений **Bash термінал** (або запустіть новий). Далі, наберіть команди:
...
*   Під кінець, переключіться на вкладку [Web][6] і натисніть **Reload**.
