...
<https://argentinaenpython.com/galeria/>`_), hemos colaborado en
...
.. raw:: html
   ...
   <div class="progress" style="width: 70%; height: 40px; margin-left: auto; margin-right: auto;">
     <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" style="width: 78.71% ;">
       <div style="margin-top: 10px;">78.71 %</div>
     </div>
   </div>
...
.. template:: bootstrap3/button
   :href: https://argentinaenpython.com/donaciones/medios/
