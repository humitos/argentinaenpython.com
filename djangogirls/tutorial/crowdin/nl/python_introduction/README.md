...
Om eens wat met Python te spelen, moeten we een commando venster openen op je computer. Als 't goed is weet je al hoe je een command venster opent, je hebt 't geleerd in het Introductie in het gebruik van het commando venster<0> hoofdstuk.</p> 
