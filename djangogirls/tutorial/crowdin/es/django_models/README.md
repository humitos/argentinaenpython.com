...
Vas notar que se crea un nuevo directorio llamado `blog` que contiene una serie de archivos. Los directorios y archivos en nuestro proyecto deberían parecerse a esto:
