...
Cascading Style Sheets (CSS) je jezik koji se koristi za opisivanje izgleda i formatiranje veb sajta napisanog u jeziku za označavanje (poput HTML-a). Možete smatrati da je to šminka za vaš veb sajt :).

Ali, ne želimo da ponovo krenemo od početka, zar ne? Mi ćemo, još jednom, da koristimo nešto što su programeri već uradili i što je objavljeno na Internetu za besplatnu upotrebu. Znate, otkrivanje tople vode nije zabavno.
