...
Tills nu har din webbsida bara funnits tillgänglig på din egen dator, nu kommer du får lära dig hur du publicerar den på nätet! Publicering är processen att göra din applikation tillgänglig på internet så att andra kan se och använda din app :).
