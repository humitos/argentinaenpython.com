...
Час відкрити `blog/templates/blog/base.html`. Додамо лінк всередині блоку `div` із ім'ям `page-header`:
    ...
    html <a href="{% url 'post_new' %}" class="top-menu"><span class="glyphicon glyphicon-plus"></span></a>
...
Якщо бажаєте дізнатись більше інформації про форми Django, ознайомтесь із документацією: https://docs.djangoproject.com/en/1.7/topics/forms/
...
Так як ви ймовірно ввійшли до системи, якщо ви оновите сторінку, нічого не зміниться. Відкрийте сторінку в новому браузері або анонімному вікні, і тоді ви побачите що посилання не показується!
...
*   Тоді, в [bash консолі PythonAnywhere][7]:
...
*   Ну й нарешті перестрибніть на [вкладку Web][8] і натисніть **Reload**.
