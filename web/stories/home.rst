...
.. class:: alert alert-success
  ...
  ¡El equipo `Argentina en Python </>`_  estará participando de dos eventos en diferentes paises!
    ...
    * Argentina: Johanna estará participando en la organización del Django Girls en el marco de  `PyCon Argentina <https://pycon.python.org.ar>`_, que se realizará el 22 de Noviembre en Buenos Aires
